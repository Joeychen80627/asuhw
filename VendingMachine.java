...
public class VendingMachine
{
    public static void main(String[] args) {
        ...
        dispenseItem(20,"candy");
        dispenseItem(4, "candy");
        dispenseItem(46, "candy");
        dispenseItem(25, "coke");
        dispenseItem(4, "coke");
        dispenseItem(46, "coke");
        dispenseItem(4, "coffee");
        dispenseItem(46, "coffee");
        dispenseItem(45, "coffee");
    }
